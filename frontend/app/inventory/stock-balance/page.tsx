    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 500, display: 'flex' }}
      ...
      <div style={{ width: 380, background: 'var(--surface, #0e0b1a)', borderLeft: '0.5px solid rgba(251,146,60,0.2)', display: 'flex', flexDirection: 'column', overflowY: 'auto' }}
        ...
        <div style={{ padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          {sections.map(sec => (
            <div key={sec.title} style={{ background: 'rgba(255,255,255,0.02)', border: `0.5px solid color-mix(in srgb, ${sec.color} 13%, transparent)`, borderRadius: 10, overflow: 'hidden' }}>
