...
const BUCKET_CFG: Record<AgingBucket, { color: string; bg: string; border: string; label: string; risk: string }> = {
  'no_movement': { color: 'var(--danger, #f87171)', bg: 'rgba(248,113,113,0.15)', border: 'rgba(248,113,113,0.3)', label: 'No Movement', risk: 'Dead'  },
  '180+':        { color: 'var(--danger, #f87171)', bg: 'rgba(248,113,113,0.12)', border: 'rgba(248,113,113,0.25)', label: '180+ days',  risk: 'Dead'  },
  '91-180':      { color: 'var(--accent-strong, #fb923c)', bg: 'rgba(251,146,60,0.12)',  border: 'rgba(251,146,60,0.25)',  label: '91–180 days', risk: 'Slow' },
  '61-90':       { color: 'var(--warning, #fbbf24)', bg: 'rgba(251,191,36,0.12)',  border: 'rgba(251,191,36,0.25)',  label: '61–90 days',  risk: 'Watch' },
  '31-60':       { color: 'var(--accent-violet, #a78bfa)', bg: 'rgba(167,139,250,0.1)',  border: 'rgba(167,139,250,0.2)',  label: '31–60 days',  risk: 'Watch' },
  '0-30':        { color: 'var(--success, #4ade80)', bg: 'rgba(74,222,128,0.08)',  border: 'rgba(74,222,128,0.2)',   label: '0–30 days',   risk: 'Fresh' },
};
      ...
      <div className="ag-page">
        ...
        <div className="ag-kpis">
          {[
            ...
            { label: 'Dead Stock',     value: fmtAmt(data?.summary.deadStockValue ?? 0),       color: 'var(--danger, #f87171)', border: 'rgba(248,113,113,0.2)'   },
          ].map(k => (
