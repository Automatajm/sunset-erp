...
function CategoryModal({ open, onClose, onSaved, initial, macroCategories }: {
  ...
  return (
    <>
      <style>{`.catm-overlay{position:fixed;inset:0;z-index:400;background:rgba(0,0,0,0.65);backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;padding:24px}.catm-box{background:var(--surface, #0e0b1a);border:0.5px solid rgba(251,146,60,0.2);border-radius:14px;width:100%;max-width:500px;box-shadow:0 24px 60px rgba(0,0,0,0.7)}.catm-hdr{display:flex;align-items:center;justify-content:space-between;padding:14px 18px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06)}.catm-title{font-size:13px;font-weight:500;color:var(--text-strong, #f1ede8)}.catm-close{width:22px;height:22px;border-radius:6px;background:rgba(255,255,255,0.06);border:none;cursor:pointer;color:rgba(255,255,255,0.4);font-size:15px;display:flex;align-items:center;justify-content:center}.catm-body{padding:14px 18px;display:flex;flex-direction:column;gap:10px}.catm-row{display:grid;grid-template-columns:1fr 1fr;gap:10px}.catm-field{display:flex;flex-direction:column;gap:5px}.catm-label{font-size:11px;font-weight:500;letter-spacing:0.08em;text-transform:uppercase;color:rgba(251,146,60,0.55)}.catm-input,.catm-select,.catm-textarea{background:rgba(255,255,255,0.04);border:0.5px solid rgba(255,255,255,0.1);border-radius:7px;padding:8px 12px;font-size:13px;font-family:'IBM Plex Sans',sans-serif;color:var(--text-strong, #f1ede8);outline:none;width:100%}.catm-input:focus,.catm-select:focus,.catm-textarea:focus{border-color:rgba(251,146,60,0.45)}.catm-select option{background:var(--surface, #0e0b1a)}.catm-textarea{resize:vertical;min-height:56px}.catm-error{background:rgba(239,68,68,0.1);border:0.5px solid rgba(239,68,68,0.25);border-radius:7px;padding:7px 12px;font-size:12px;color:var(--danger-subtle, #fca5a5)}.catm-ftr{display:flex;justify-content:flex-end;gap:8px;padding:10px 18px 16px;border-top:0.5px solid rgba(255,255,255,0.06)}.catm-btn-cancel{background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.1);border-radius:7px;padding:7px 14px;font-size:12px;font-family:'IBM Plex Sans',sans-serif;color:rgba(255,255,255,0.45);cursor:pointer}.catm-btn-save{background:linear-gradient(135deg,var(--accent-pressed, #c2410c),var(--accent, #ea580c),var(--accent-mid, #f97316));border:none;border-radius:7px;padding:7px 18px;font-size:12px;font-weight:500;font-family:'IBM Plex Sans',sans-serif;color:white;cursor:pointer}.catm-btn-save:disabled{opacity:0.5;cursor:not-allowed}`}</style>
  ...
  return (
    <ERPShell breadcrumbs={['Home', 'Inventory', 'Categories']} title="Categories">
      <style>{`
        ...
        .catp-page{padding:0 18px 24px}.catp-toolbar{display:flex;align-items:center;gap:10px;margin-bottom:14px;flex-wrap:wrap}.catp-search{background:rgba(255,255,255,0.04);border:0.5px solid rgba(255,255,255,0.09);border-radius:7px;padding:7px 12px;font-size:12px;font-family:'IBM Plex Sans',sans-serif;color:var(--text-primary, #e2dfd8);outline:none;width:220px}.catp-search:focus{border-color:rgba(251,146,60,0.4)}.catp-select{background:rgba(255,255,255,0.04);border:0.5px solid rgba(255,255,255,0.09);border-radius:7px;padding:7px 12px;font-size:12px;font-family:'IBM Plex Sans',sans-serif;color:var(--text-primary, #e2dfd8);outline:none;cursor:pointer}.catp-select option{background:var(--surface, #0e0b1a)}.catp-btn-new{margin-left:auto;display:flex;align-items:center;gap:6px;background:linear-gradient(135deg,var(--accent-pressed, #c2410c),var(--accent, #ea580c),var(--accent-mid, #f97316));border:none;border-radius:7px;padding:7px 14px;font-size:12px;font-weight:500;font-family:'IBM Plex Sans',sans-serif;color:white;cursor:pointer;box-shadow:0 3px 12px rgba(234,88,12,0.3);transition:opacity 0.15s}.catp-btn-new:hover{opacity:0.88}.catp-wrap{background:rgba(10,7,18,0.7);border:0.5px solid rgba(251,146,60,0.12);border-radius:10px;overflow:hidden}.catp-table{width:100%;border-collapse:collapse}.catp-table thead th{padding:9px 14px;font-size:10px;font-weight:500;letter-spacing:0.1em;text-transform:uppercase;color:rgba(251,146,60,0.55);background:rgba(251,146,60,0.05);border-bottom:0.5px solid rgba(255,255,255,0.06);text-align:left}.catp-table tbody td{padding:10px 14px;border-bottom:0.5px solid rgba(255,255,255,0.04);font-size:13px;vertical-align:middle}.catp-table tbody tr:last-child td{border-bottom:none}.catp-table tbody tr:hover td{background:rgba(251,146,60,0.03)}.catp-code{font-family:'IBM Plex Mono',monospace;font-size:12px;color:var(--accent-strong, #fb923c)}.catp-muted{color:rgba(255,255,255,0.4);font-size:12px}.catp-macro{display:inline-flex;align-items:center;padding:2px 8px;border-radius:20px;font-size:11px;font-weight:500;color:var(--accent-violet, #a78bfa);background:rgba(167,139,250,0.1);border:0.5px solid rgba(167,139,250,0.25)}.catp-actions{display:flex;gap:6px}.catp-btn-edit{padding:4px 10px;border-radius:6px;font-size:11px;font-family:'IBM Plex Sans',sans-serif;cursor:pointer;background:rgba(255,255,255,0.05);color:rgba(255,255,255,0.5);border:0.5px solid rgba(255,255,255,0.1)}.catp-btn-edit:hover{background:rgba(255,255,255,0.09)}.catp-empty,.catp-loading{text-align:center;padding:52px 24px;color:rgba(255,255,255,0.25);font-size:13px}.catp-footer{font-size:11px;color:rgba(255,255,255,0.22);padding:8px 14px;border-top:0.5px solid rgba(255,255,255,0.04)}.catp-error{background:rgba(239,68,68,0.08);border:0.5px solid rgba(239,68,68,0.2);border-radius:8px;padding:9px 14px;margin-bottom:14px;font-size:12px;color:var(--danger-subtle, #fca5a5)}
      `}</style>
                ...
                <tbody>
                  {filtered.map(cat => (
                    <tr key={cat.id}>
                      ...
                      <td style={{ color: 'var(--text-primary, #e2dfd8)', fontWeight: 500 }}>{cat.name}</td>
