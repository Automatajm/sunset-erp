...
function CategoryModal({ open, onClose, onSaved, initial, macroCategories }: {
  ...
  return (
    <>
      <style>{`.catm-overlay{position:fixed;inset:0;z-index:400;background:rgba(0,0,0,0.65);backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;padding:24px}.catm-box{background:var(--surface);border:0.5px solid rgba(251,146,60,0.2);border-radius:14px;width:100%;max-width:500px;box-shadow:0 24px 60px rgba(0,0,0,0.7)}.catm-hdr{display:flex;align-items:center;justify-content:space-between;padding:14px 18px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06)}.catm-title{font-size:13px;font-weight:500;color:var(--text-strong)}.catm-close{width:22px;height:22px;border-radius:6px;background:rgba(255,255,255,0.06);border:none;cursor:pointer;color:rgba(255,255,255,0.4);font-size:15px;display:flex;align-items:center;justify-content:center}.catm-body{padding:14px 18px;display:flex;flex-direction:column;gap:10px}.catm-row{display:grid;grid-template-columns:1fr 1fr;gap:10px}.catm-field{display:flex;flex-direction:column;gap:5px}.catm-label{font-size:11px;font-weight:500;letter-spacing:0.08em;text-transform:uppercase;color:rgba(251,146,60,0.55)}.catm-input,.catm-select,.catm-textarea{background:rgba(255,255,255,0.04);border:0.5px solid rgba(255,255,255,0.1);border-radius:7px;padding:8px 12px;font-size:13px;font-family:'IBM Plex Sans',sans-serif;color:var(--text-strong);outline:none;width:100%}.catm-input:focus,.catm-select:focus,.catm-textarea:focus{border-color:rgba(251,146,60,0.45)}.catm-select option{background:var(--surface)}.catm-textarea{resize:vertical;min-height:56px}.catm-error{background:rgba(239,68,68,0.1);border:0.5px solid rgba(239,68,68,0.25);border-radius:7px;padding:7px 12px;font-size:12px;color:var(--danger-subtle)}.catm-ftr{display:flex;justify-content:flex-end;gap:8px;padding:10px 18px 16px;border-top:0.5px solid rgba(255,255,255,0.06)}.catm-btn-cancel{background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.1);border-radius:7px;padding:7px 14px;font-size:12px;font-family:'IBM Plex Sans',sans-serif;color:rgba(255,255,255,0.45);cursor:pointer}.catm-btn-save{background:linear-gradient(135deg,var(--accent-pressed),var(--accent),var(--accent-mid));border:none;border-radius:7px;padding:7px 18px;font-size:12px;font-weight:500;font-family:'IBM Plex Sans',sans-serif;color:white;cursor:pointer}.catm-btn-save:disabled{opacity:0.5;cursor:not-allowed}`}</style>
