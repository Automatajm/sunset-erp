          ...
          return (
            <span key={f.key} style={BADGE} onClick={() => setCollapsed(false)} title="Click to edit filters">
              ...
              <button
                ...
                style={{ background: 'rgba(251,146,60,0.15)', border: 'none', borderRadius: '50%', width: 15, height: 15, cursor: 'pointer', color: 'var(--accent-strong, #fb923c)', fontSize: 10, lineHeight: 1, padding: 0, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}
              >×</button>
            </span>
          );
        })}
